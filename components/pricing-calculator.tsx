            ...
            >
              ...
              <Button
                ...
                className={`mt-auto w-full ${
                  plan.popular
                    ? "bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:scale-105 hover:to-purple-700"
                    : "bg-white/10 hover:bg-white/20 text-white hover:bg-gradient-to-r hover:from-blue-700 hover:to-purple-700 hover:tracking-widest hover:text-md hover:font-bold"
